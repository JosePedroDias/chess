...
test('pawn moves double white', (_t) => {
    ...
    const pos = 'b2';
    b.set(pos, 'P');
    const moves = pawnMoves(pos, true);
    for (const mv of moves) b.set(mv, '*');
    equal(b.toString(),
`. . . . . . . .
. . . . . . . .
...
test('pawn moves double black', (_t) => {
    ...
    const pos = 'g7';
    b.set(pos, 'p');
    const moves = pawnMoves(pos, false);
    for (const mv of moves) b.set(mv, '*');
    equal(b.toString(),
`. . . . . . . .
. . . . . . p .
